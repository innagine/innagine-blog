...
import BilibiliIcon from "@site/static/icons/csdn.svg";
        ...
        <animated.div className="hero">
          <div className="bloghome__intro">
            <animated.h1 style={animatedTexts[0]}>
              Hello! 我是<span className="intro__name">innagine</span>
            </animated.h1>
...
function SocialLinks({ animatedProps, ...props }) {
  ...
  return (
    <animated.div className="social__links" style={animatedProps}>
      <a href="https://blog.csdn.net/imagine_tion">
        <BilibiliIcon />
      </a>
      {/* <a href="https://www.linkedin.com/in/zxuqian/">
        <FontAwesomeIcon icon={faLinkedin} size="lg" />
      </a> */}
      <a href="https://github.com/innagine">
